...
export function ItemFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <form onSubmit={handleSubmit} className="w-full max-w-md rounded-xl bg-surface p-5 shadow-xl">
        <h2 className="text-lg font-semibold text-ink">{isEdit ? 'Edit item' : 'New item'}</h2>

        {error && <p className="mt-2 text-sm text-red-600">{error}</p>}

        <div className="mt-4 space-y-3">
          <div>
            <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-ink-muted">Name</label>
            <input
              autoFocus
              value={name}
          ...
          <div>
            <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-ink-muted">VAT rate</label>
            <select
              value={taxAmount}
          ...
          <div>
            <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-ink-muted">Course</label>
            <select
              value={course}
          ...
          <div className="rounded-lg border border-border p-3">
            ...
            {soldByWeight && (
              <div className="mt-2">
                <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-ink-muted">Unit</label>
                <select
                  value={weightUnit}
          ...
          <div>
            <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-ink-muted">Image (optional)</label>
